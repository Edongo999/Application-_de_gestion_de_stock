    ...
    <div class="box">
            <form action="<?= !empty($_GET['id']) ?  "../model/modifArticle.php" : "../model/ajoutArticle.php" ?>" method="post">
                ...
                <select name="categorie" id="categorie">
                 ...
                 <?php
                // Assurez-vous que $article['date_fabrication'] et $article['date_expiration'] sont correctement formatés
                $date_fabrication = !empty($_GET['id']) ? date('Y-m-d\TH:i', strtotime($article['date_fabrication'])) : '';
                $date_expiration = !empty($_GET['id']) ? date('Y-m-d\TH:i', strtotime($article['date_expiration'])) : '';
                ?>
                ...
                <input value="<?= $date_fabrication ?>" type="datetime-local" name="date_fabrication" id="date_fabrication">

                <label for="date_expiration">Date d'expiration</label>
                <input value="<?= $date_expiration ?>" type="datetime-local" name="date_expiration" id="date_expiration">
        ...
        <div class="box1">
                ...
                ?>
                        <tr>
                            ...
                            <td><a href="?id=<?= $value['id'] ?>"><i class='bi bi-pencil '></i></a></td>
                            </tr>  
                            <?php
                            }
                        }
